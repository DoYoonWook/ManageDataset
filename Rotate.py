        ...
        for angle in angle_list:
            for img_name in os.listdir(imgs_path):
                ...
                if s == ".jpg":
                    ...
                    if angle in [90, 270]:
                        d = tree.find('size')
                        width = float(d.find('width').text)
                        height = float(d.find('height').text)
...
if __name__ == '__main__':
    ...
    img_root_path = './test_voc/images/'
    xml_root_path = './test_voc/annotations/'
    img_save_path = './rotate_voc/images/'
    xml_save_path = './rotate_voc/annotations/'
    angle_list = [60, 90, 120, 150, 180, 270]
    img_aug.process_img(img_root_path, xml_root_path, img_save_path, xml_save_path, angle_list)
